            ...
            <tbody>
                @foreach($distributions as $distribution)
                    <tr>
                        ...
                        <td>{{ $distribution->recipient_contact }}</td>
                        <td>{{ number_format($distribution->amount, 2) }}</td>
                        <td>{{ $distribution->details }}</td>
                        <td>{{ $distribution->created_at->format('M d, Y H:i:s') }}</td>
                        <td>
                            <img src="{{ asset('storage/' . $distribution->item_image_path) }}" alt="Item Image" style="width: 50px; height: auto;">
                        </td>
                    </tr>
                @endforeach
            </tbody>
