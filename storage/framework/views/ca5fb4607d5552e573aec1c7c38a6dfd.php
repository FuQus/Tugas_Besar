        ...
        <div class="container">
            ...
            <div class="header-links">
                <?php if(auth()->guard()->check()): ?>
                    <span class="nav-link">Welcome, <?php echo e(Auth::user()->name); ?></span> <!-- Menampilkan nama pengguna -->
                    <form id="logout-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: inline;">
                        <?php echo csrf_field(); ?>
                        <a href="<?php echo e(route('logout')); ?>" class="btn btn-danger" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                    </form>
                <?php endif; ?>
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(url('/signin')); ?>" class="btn btn-primary">Sign In</a>
                    <a href="<?php echo e(url('/register')); ?>" class="btn btn-secondary">Register</a>
                <?php endif; ?>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    <img src="<?php echo e(asset('assets/imgs/hehe.jpg')); ?>" alt="" class="brand-img">
                    <li class="brand-txt">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card mb-5">
                    ...
                    <div class="card-body px-4 py-3">
                        ...
                        <a href="<?php echo e(route('distributions.index')); ?>" class="btn btn-primary">Kelola Distribusi</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="card mb-5">
                    ...
                    <div class="card-body px-4 py-3">
                        ...
                        <a href="<?php echo e(route('donations.index')); ?>" class="btn btn-primary">Kelola Donasi</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card mb-5">
                    ...
                    <div class="card-body px-4 py-3">
                        ...
                        <a href="<?php echo e(route('programmers.index')); ?>" class="btn btn-primary">ABOUT</a>
                    </div>
                </div>
            </div>
</section>
                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/web-1.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/web-1.jpg')); ?>"></a>
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/web-2.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/web-2.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/advertising-2.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                         
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/advertising-2.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/web-4.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/web-4.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising"> 
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/advertising-1.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                               
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/advertising-1.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/web-3.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">  
                           <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/web-3.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/advertising-3.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">       
                           <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/advertising-3.jpg')); ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title"></h6>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new"> 
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/advertising-4.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">            
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/advertising-4.jpg')); ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">BPBD</h6>
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/branding-1.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                        
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/branding-1.jpg')); ?>"></a>
                                <div class="text-holder">
                                    <h6 class="title">PMI</h6>
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/branding-2.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">  
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/branding-2.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/branding-3.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">   
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/branding-3.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/branding-4.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                      
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/branding-4.jpg')); ?>"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo e(asset('assets/imgs/branding-5.jpg')); ?>" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">          
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo e(asset('assets/imgs/branding-5.jpg')); ?>"></a>
                                <div class="text-holder">
            ...
            <div class="row">
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('assets/imgs/blog1.jpg')); ?>" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
...
“Donasi ini merupakan bentuk kepedulian dan solidaritas masyarakat Nagan Raya terhadap rakyat Palestina yang saat ini sedang dalam kondisi yang sulit. Kami berharap donasi ini dapat meringankan beban dan membantu saudara-saudara kita di Palestina,” kata Ardimartha yang juga Sekretaris Daerah (Sekda) Kabupaten Nagan Raya.</p>
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('assets/imgs/blog2.jpg')); ?>" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
                ...
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo e(asset('assets/imgs/blog3.jpg')); ?>" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
    ...
    <!-- Isotope  -->
    <script src="<?php echo e(asset('assets/vendors/isotope/isotope.pkgd.js')); ?>"></script>
    
    <!-- Google mpas -->
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtme10pzgKSPeJVJrG1O3tjR6lk98o4w8&callback=initMap"></script>

    <!-- JohnDoe js -->
    <script src="<?php echo e(asset('assets/js/johndoe.js')); ?>"></script>

</body>
</html><?php /**PATH D:\Aqua\TugasNegara\ProjekWeb\back-end-projek\resources\views/index.blade.php ENDPATH**/ ?>